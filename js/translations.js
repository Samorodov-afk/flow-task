...
export const translations = {
    ru: {
        ...
        'quickStartTips': 'Быстрые шаги',
        'hideTips': 'Скрыть',
        'tipCreateTask': 'Создай первую задачу',
        'tipChoosePriority': 'Выбери приоритет',
        'tipSetDeadline': 'Поставь дедлайн',
        'tipUseShortcuts': 'Используй горячие клавиши',
        // Другие
    ...
    en: {
        ...
        'quickStartTips': 'Quick steps',
        'hideTips': 'Hide',
        'tipCreateTask': 'Create your first task',
        'tipChoosePriority': 'Pick a priority',
        'tipSetDeadline': 'Set a deadline',
        'tipUseShortcuts': 'Use shortcuts',
        // Others
